...
for lang in en fr de ru hi; do
    # learn codes
    ./fastBPE/fast learnbpe ${n_ops} ${monolingual_file}.clean.${lang} > ${monolingual_file}.${lang}.codes
...
for lang in fr de ru hi; do
    ...
    ./fastBPE/fast applybpe ${file}.train.clean.bpe_${n_ops}.en ${file}.train.clean.en ${monolingual_file}.en.codes ${monolingual_file}.clean.bpe_${n_ops}.en.vocab
    # apply codes to dev
    ...
    ./fastBPE/fast applybpe ${file}.dev.clean.bpe_${n_ops}.en ${file}.dev.clean.en ${monolingual_file}.en.codes ${monolingual_file}.clean.bpe_${n_ops}.en.vocab
    # apply codes to test
    ...
    ./fastBPE/fast applybpe ${file}.test.clean.bpe_${n_ops}.en ${file}.test.clean.en ${monolingual_file}.en.codes ${monolingual_file}.clean.bpe_${n_ops}.en.vocab
done