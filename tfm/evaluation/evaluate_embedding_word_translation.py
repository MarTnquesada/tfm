...
from tfm.crossmapping.vecmap.cupy_utils import *
...
def main():
    ...
    parser.add_argument('--retrieval', default='csls', choices=['nn', 'invnn', 'invsoftmax', 'csls'], help='the retrieval method (nn: standard nearest neighbor; invnn: inverted nearest neighbor; invsoftmax: inverted softmax; csls: cross-domain similarity local scaling)')
    ...
    parser.add_argument('--dot', action='store_true', help='use the dot product in the similarity computations instead of the cosine (AKA measure L2 distance instead of cosine similarity)')
