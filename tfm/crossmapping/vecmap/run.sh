...
for lang in fr de ru hi; do
    ...
    dimension=150
    python -m tfm.crossmapping.vecmap.map_embeddings data/embeddings/monolingual-${lang}-3-6-${dimension}.vec data/embeddings/monolingual-en-3-6-${dimension}.vec data/embeddings/monolingual-${lang}-3-6-${dimension}-en.vec data/embeddings/monolingual-en-3-6-${dimension}-${lang}.vec --batch_size 1000 --unsupervised --verbose
    dimension=200
    python -m tfm.crossmapping.vecmap.map_embeddings data/embeddings/monolingual-${lang}-3-6-${dimension}.vec data/embeddings/monolingual-en-3-6-${dimension}.vec data/embeddings/monolingual-${lang}-3-6-${dimension}-en.vec data/embeddings/monolingual-en-3-6-${dimension}-${lang}.vec --batch_size 1000 --unsupervised --verbose
    dimension=250
    python -m tfm.crossmapping.vecmap.map_embeddings data/embeddings/monolingual-${lang}-3-6-${dimension}.vec data/embeddings/monolingual-en-3-6-${dimension}.vec data/embeddings/monolingual-${lang}-3-6-${dimension}-en.vec data/embeddings/monolingual-en-3-6-${dimension}-${lang}.vec --batch_size 1000 --unsupervised --verbose
